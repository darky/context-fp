export function cfp<C, T1, R>(dep1: (ctx: C) => T1, fn: (x1: T1) => R): ((ctx: C) => R) & { raw: (x1: T1) => R }
export function cfp<C, T1, T2, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  fn: (x1: T1, x2: T2) => R
): ((ctx: C) => R) & { raw: (x1: T1, x2: T2) => R }
export function cfp<C, T1, T2, T3, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  fn: (x1: T1, x2: T2, x3: T3) => R
): ((ctx: C) => R) & { raw: (x1: T1, x2: T2, x3: T3) => R }
export function cfp<C, T1, T2, T3, T4, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp<C, T1, T2, T3, T4, T5, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp<C, T1, T2, T3, T4, T5, T6, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp<C, T1, T2, T3, T4, T5, T6, T7, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp<C, T1, T2, T3, T4, T5, T6, T7, T8, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp<C, T1, T2, T3, T4, T5, T6, T7, T8, T9, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp<C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R>(
  dep1: (ctx: C) => T1,
  dep2: (ctx: C) => T2,
  dep3: (ctx: C) => T3,
  dep4: (ctx: C) => T4,
...
export function cfp(...fns: ((...args: unknown[]) => unknown)[]) {
  ...
  return Object.assign(
    (context: unknown, cache = new Map()) => {
      const depsResp: unknown[] = []
      deps.forEach(dep => {
        if (cache.has(dep)) {
          depsResp.push(cache.get(dep))
        } else {
          const resp = dep(context, cache)
          cache.set(dep, resp)
          depsResp.push(resp)
        }
      })
